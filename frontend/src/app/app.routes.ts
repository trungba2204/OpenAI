...
export const routes: Routes = [
  ...
  { path: 'workspaces', redirectTo: 'plugins', pathMatch: 'full' },
  { path: 'workspaces/:id', redirectTo: 'plugins', pathMatch: 'full' },
  { path: 'projects/:id', redirectTo: 'plugins', pathMatch: 'full' },
  {
    path: 'plugins',
